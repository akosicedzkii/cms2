<section id="page-content">
                ...
                <div class="row justify-content-center">
                    <?php if($lubricants_products != null){?>
                        <?php foreach($lubricants_products as $row){?>
                            <div class="col-12 col-sm-6 col-md-5 lubricant-item animate fade-in" data-group="lubricants">
                                ...
                                <div class="btn-spacer text-center">
                                    <a data-toggle="modal" href="#" onclick="view_product_details(<?php echo $row->id?>,'<?php echo strtoupper($row->series_name);?>');return false;"class="ghost-btn blue">SEE PRODUCTS</a>
                                </div>
                            </div>
                        <?php }?>
                    <?php }?>
    ...
    <script>
        function view_product_details(series_id,series_name)
        {
