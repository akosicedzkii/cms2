...
<script>
    ...
    var main = function(){
        ...
        $("#downloadBtn").click(function(){
            window.open ("<?php echo base_url()."cms/logs/download?fromDate="?>" + startDateDownload + "&toDate=" + endDateDownload,"_blank") ;
        });
    }
    ...
    function _view(id)
    {
        var values = { "id": id };
        $.ajax({
            url: "<?php echo base_url();?>cms/logs/get_log_details",
            type: "post",
            data: values ,
            success: function (response) {
