        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url("assets/images/person-icon-blue.png");?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata("FULLNM");?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url("assets/images/person-icon-blue.png");?>" class="img-circle" alt="User Image">
                <p>
              ...
              <li class="<?php if($module_name == "banners" || $module_name == "mid_banners" ){echo 'active ';}?>treeview">
                ...
                <ul class="treeview-menu">
                  <?php 
                    if (in_array("banners", $menu)) {
                     ?>
                        <li <?php if($module_name == "banners"){echo 'class="active"';}?>><a href="<?php echo base_url()."cms/main/banners"?>"><i class="glyphicon glyphicon-picture"></i><span>Main Banners</span></a></li>
                      <?php
                     } 
                  ?>
                  <?php 
