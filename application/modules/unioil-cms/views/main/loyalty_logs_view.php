...
<script>
    ...
    var table = $('#loyalty_logsList').DataTable({ 
        ...
        "processing" : true,
        "serverSide" : true, 
        "ajax" : "<?php echo base_url()."unioil-cms/loyalty_logs/get_loyalty_logs_list";?>",
    ...
    var main = function(){
        ...
        $("#deleteLogs").click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url();?>unioil-cms/loyalty_logs/delete_all_loyalty_logs",
                type: "post",
                data: values ,
        ...
        $("#downloadBtn").click(function(){
            window.open ("<?php echo base_url()."unioil-cms/loyalty_logs/download?fromDate="?>" + startDateDownload + "&toDate=" + endDateDownload,"_blank") ;
        });
    }
    ...
    function _view(id)
    {
        var values = { "id": id };
        $.ajax({
            url: "<?php echo base_url();?>unioil-cms/loyalty_logs/get_loyalty_log_details",
            type: "post",
            data: values ,
            success: function (response) {
