...
<script>
    ...
    var main = function(){
        ...
        var table = $('#userList').DataTable({  
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/users/get_user_list";?>",
        ...
        $("#addBtn").click(function(){
            ...
            $("#action").val("add");
            $("#inputUsername").attr("data-remote","<?php echo base_url()."unioil-cms/users/check_username_exist?method=add";?>");
            $(".add").show();     
            $('#userForm').validator();
        ...
        $("#userForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/users/add_user";?>";
                var message = "New user successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/users/edit_user";?>";
        ...
        $("#deleteUser").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/users/delete_user";?>",
    ...
    function _edit(id)
    {
        ...
        $('#userForm').validator();    
        $("#action").val("edit");
        $("#inputUsername").attr("data-remote","<?php echo base_url()."unioil-cms/users/check_username_exist?method=edit&user_id=";?>" + id);
        var data = { "id" : id }
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/users/get_user_data";?>",
                success: function(data){
