...
<script>
    ...
    var main = function(){
        var table = $('#mid_bannersList').DataTable({  
            ...
            "serverSide" : true, 
            "responsive" : true,
            "ajax" : "<?php echo base_url()."unioil-cms/mid_banners/get_mid_banners_list";?>",
        ...
        $("#mid_bannersForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/mid_banners/add_mid_banner";?>";
                var message = "New mid banner successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/mid_banners/edit_mid_banner";?>";
        ...
        $("#deleteMidBanners").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/mid_banners/delete_mid_banner";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/mid_banners/get_banner_data";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({  
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=mid_banners";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
