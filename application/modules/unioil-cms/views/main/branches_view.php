...
<script>
    ...
    var main = function(){
        var table = $('#branchList').DataTable({  
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/branches/get_branches_list";?>",
        ...
        $("#branchForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/branches/add_branch";?>";
                var message = "New branch successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/branches/edit_branch";?>";
        ...
        $("#deleteBranch").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/branches/delete_branch";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/branches/get_branches_data";?>",
                success: function(data){
