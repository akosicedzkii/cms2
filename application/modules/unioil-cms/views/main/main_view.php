      ...
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <?php 
              ...
              ?>
                  <a href="<?php echo base_url("unioil-cms/main/products");?>" class="uppercase">View All Products</a>
              <?php }?>
            </div>
            <!-- /.box-footer -->
          </div>
              ...
              <div class="box box-danger">
                ...
                <div class="box-footer text-center">
                    <?php 
                        ...
                        ?>
                          <a href="<?php echo base_url("unioil-cms/main/users");?>" class="uppercase">View All Users</a>
                    <?php }?>
                </div>
                <!-- /.box-footer -->
              </div>
   ...
   var main = function()
   {
    ...
    $("#filter").change(function(){
        ...
        $.ajax({
          type: "get",
          data: data,
          url: "<?php echo base_url("unioil-cms/main/visitor_map");?>" ,
