...
<div class="modal fade" id="uploadPricesModal" role="dialog"  data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <a href="<?php echo base_url("unioil-cms/stations/download_station_prices");?>" download>Download Prices Template</a>
...
<script>
    ...
    var main = function(){
        var table = $('#stationList').DataTable({  
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/stations/get_stations_list";?>",
        ...
        $("#stationForm").validator().on('submit', function (e) {
           fuel_price = "";
            ...
            if (!e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/stations/add_station";?>";
                var message = "New station successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/stations/edit_station";?>";
        ...
        $("#savePriceList").click(function(){
            ...
            $.ajax({
                ...
                contentType: false,
                cache: false,
                url: "<?php echo base_url()."unioil-cms/stations/upload_prices";?>" ,
                xhr: function(){
                    //upload Progress
                    var xhr = $.ajaxSettings.xhr();
                    if (xhr.upload) {
        ...
        $("#deleteStation").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/stations/delete_station";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/stations/get_stations_data";?>",
                success: function(data){
