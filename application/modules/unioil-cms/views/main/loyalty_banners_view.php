...
<script>
    ...
    var main = function(){
        var table = $('#loyalty_bannersList').DataTable({  
            ...
            "serverSide" : true, 
            "responsive" : true,
            "ajax" : "<?php echo base_url()."unioil-cms/loyalty_banners/get_loyalty_banners_list";?>",
        ...
        $("#loyalty_bannersForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/loyalty_banners/add_loyalty_banner";?>";
                var message = "New Loyalty Banner successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/loyalty_banners/edit_loyalty_banner";?>";
        ...
        $("#deleteLoyaltyBanners").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/loyalty_banners/delete_loyalty_banner";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/loyalty_banners/get_banner_data";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({  
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=loyalty_banners";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
