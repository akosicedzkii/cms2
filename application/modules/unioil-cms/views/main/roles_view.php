...
<script>
    ...
    var main = function(){
        var table = $('#roleList').DataTable({  
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/roles/get_roles_list";?>",
        ...
        $("#roleForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/roles/add_role";?>";
                var message = "New role successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/roles/edit_role";?>";
        ...
        $("#deleteRole").click(function(){
            ...
            $.ajax({
                    data: data,
                    type: "post",
                    url: "<?php echo base_url()."unioil-cms/roles/delete_role";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/roles/get_role_data";?>",
                success: function(data){
