...
<script>
    ...
    var table = $('#logsList').DataTable({ 
        ...
        "processing" : true,
        "serverSide" : true, 
        "ajax" : "<?php echo base_url()."unioil-cms/logs/get_logs_list";?>",
    ...
    var main = function(){
        ...
        $("#deleteLogs").click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url();?>unioil-cms/logs/delete_all_logs",
                type: "post",
                data: values ,
        ...
        $("#downloadBtn").click(function(){
            window.open ("<?php echo base_url()."unioil-cms/logs/download?fromDate="?>" + startDateDownload + "&toDate=" + endDateDownload,"_blank") ;
        });
    }
    ...
    function _view(id)
    {
        var values = { "id": id };
        $.ajax({
            url: "<?php echo base_url();?>unioil-cms/logs/get_log_details",
            type: "post",
            data: values ,
            success: function (response) {
