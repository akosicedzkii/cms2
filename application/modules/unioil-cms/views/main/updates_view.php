...
<script>
    ...
    var main = function(){
        var table = $('#updatesList').DataTable({
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/updates/get_updates_list";?>",
        ...
        $("#updatesForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/updates/add_updates";?>";
                var message = "New updates successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/updates/edit_updates";?>";
        ...
        $("#deleteUpdates").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/updates/delete_updates";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/updates/get_updates_data";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({  
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=updates";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
