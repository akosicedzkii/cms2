...
<script>
    ...
    var main = function(){
        var table = $('#newsList').DataTable({
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/news/get_news_list";?>",
        ...
        $("#newsForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                if( !messageLength ) {
                 ...
                 //fromthis    
                 var url = "<?php echo base_url()."unioil-cms/news/add_news";?>";
                var message = "New news successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/news/edit_news";?>";
        ...
        $("#deleteNews").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/news/delete_news";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/news/get_news_data";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({  
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=news";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
