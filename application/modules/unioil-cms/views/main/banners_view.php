...
<script>
    ...
    var main = function(){
        var table = $('#bannersList').DataTable({  
            ...
            "serverSide" : true, 
            "responsive" : true,
            "ajax" : "<?php echo base_url()."unioil-cms/banners/get_banners_list";?>",
        ...
        $("#bannersForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/banners/add_banner";?>";
                var message = "New banners successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/banners/edit_banner";?>";
        ...
        $("#deleteBanners").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/banners/delete_banner";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/banners/get_banner_data";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({ 
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=banners";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
