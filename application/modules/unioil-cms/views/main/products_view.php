...
<script>
    ...
    var main = function(){
        var table = $('#productsList').DataTable({  
            ...
            "processing" : true,
            "serverSide" : true, 
            "ajax" : "<?php echo base_url()."unioil-cms/products/get_products_list";?>",
        ...
        $("#productForm").validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                var url = "<?php echo base_url()."unioil-cms/products/add_products";?>";
                var message = "New products successfully added";
                if(action == "edit")
                {
                    url =  "<?php echo base_url()."unioil-cms/products/edit_products";?>";
        ...
        $("#deleteProducts").click(function(){
            ...
            $.ajax({
                        data: data,
                        type: "post",
                        url: "<?php echo base_url()."unioil-cms/products/delete_products";?>",
    ...
    function _edit(id)
    {
        ...
        $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/products/get_products_data";?>",
                success: function(data){
    ...
    function check_series()
    {
        ...
        else
        {
            ...
            $.ajax({
                data: data,
                type: "post",
                url: "<?php echo base_url()."unioil-cms/products/get_product_series";?>",
                success: function(data){
    ...
    var new_table = $('#imageGalleryTable').DataTable({ 
            ...
            "ajax" : "<?php echo base_url()."unioil-cms/media/get_media_list?module=products";?>",
            "initComplete": function(settings,json){
                $('[data-toggle="tooltip"]').tooltip()
            }
            ,"columnDefs": [
